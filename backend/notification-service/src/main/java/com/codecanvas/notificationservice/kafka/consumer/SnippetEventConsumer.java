...
import com.codecanvas.notificationservice.client.UserServiceClient;
        ...
        try {
            if (event.getSnippetOwnerId() != null && !event.getSnippetOwnerId().equals(event.getUserId())) {
                ...
                CreateNotificationRequest request = CreateNotificationRequest.builder()
                        ...
                        .title("Snippet Liked")
                        .message(user.getFullName() + " liked your snippet.")
                        .build();
        ...
        try {
            if (event.getUserId() != null) {
                ...
                CreateNotificationRequest request = CreateNotificationRequest.builder()
                        ...
                        .message(user.getFullName() + " bookmarked a snippet.")
                        .build();
        ...
        try {
            if (event.getSnippetOwnerId() != null && !event.getSnippetOwnerId().equals(event.getUserId())) {
                ...
                CreateNotificationRequest request = CreateNotificationRequest.builder()
                        ...
                        .title("New Comment")
                        .message(user.getFullName() + " commented on your snippet.")
                        .build();
        ...
        try {
            if (event.getOriginalOwnerId() != null && !event.getOriginalOwnerId().equals(event.getForkedBy())) {
                ...
                CreateNotificationRequest request = CreateNotificationRequest.builder()
                        ...
                        .message(user.getFullName() + " forked your snippet.")
                        .build();
